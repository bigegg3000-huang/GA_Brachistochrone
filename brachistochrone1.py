...
def rand(x, y):         # R^2 > R인 랜덤 실수 함수
    return uniform(x, y)
def intrand(x, y):      # R^2 > Z인 랜덤 정수 함수
...
def rand2num(x, y):         # R^2 > Z^2인 랜덤 정수 함수
    num1 = intrand(x, y)
    num2 = intrand(x, y)
    while num1 == num2:
        num2 = intrand(x, y)
...
mut_rate = 0.3
print('Making Cycloid by Genetic Algorithm')
